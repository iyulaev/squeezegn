...
if diff -q testdata_1_input.txt testdata_1_decompressed.txt > /dev/null; then
...
if diff -q testdata_2_input.txt testdata_2_decompressed.txt > /dev/null; then
...
if diff -q testdata_3_input.txt testdata_3_decompressed.txt > /dev/null; then
...
if diff -q testdata_4_input.txt testdata_4_decompressed.txt > /dev/null; then
...
if diff -q testdata_5_input.txt testdata_5_decompressed.txt > /dev/null; then
